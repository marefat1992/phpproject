             ...
             <div class="col col-md-12">
              <?php while($data=mysqli_fetch_array($query)): ?>
                <?php $_SESSION['post_id'] = $data['id']; ?>
                 ...
                 <form action="include/deletefile.php" method="POST"><!--satrt of form for delete-->
                 <!-- <a href="" class="btn btn-outline-danger"><i class="fas fa-trash"></i></a>  -->
                 <button type="submit" name="deleteBtn" class="btn btn-outline-danger"><i class="fas fa-trash">delete</i></button>
                 <input type="hidden" name="hidden" value="<?php echo $data['id'];?>">
                 </form><!--end of form for delete-->
                 <form action="edite.php" method="POST"><!--start of edit-->
